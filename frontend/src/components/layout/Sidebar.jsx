...
export default function Sidebar({ collapsed, setCollapsed }) {
  const { isManagerOrAdmin, logout } = useAuth();
  ...
  return (
    ...
    >
      ...
      <nav style={{ flex: 1, overflowY: 'auto', padding: '20px 10px 12px', display: 'flex', flexDirection: 'column', gap: 3 }}>
        ...
        {isManagerOrAdmin && (
          <>
            <div style={{ padding: collapsed ? '18px 0 4px' : '20px 4px 4px' }}>
              {!collapsed && (
                <p
                  style={{
                    fontSize: 9,
              ...
              {collapsed && <div style={{ height: 1, background: '#E5E7EB', margin: '0 4px' }} />}
            </div>
      ...
      <div style={{ borderTop: '1px solid #E5E7EB', padding: '8px' }}>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            Object.assign(e.currentTarget.style, { color: '#2563EB', background: '#EFF6FF' });
          }}
          onMouseLeave={(e) => {
            Object.assign(e.currentTarget.style, { color: '#94A3B8', background: 'transparent' });
          }}
        >
